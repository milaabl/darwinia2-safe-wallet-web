...
const networks: ChainInfo[] = [
  {
    transactionService: 'https://darwinia.subscan.io/evm_transaction',
    chainId: '46',
    chainName: 'Darwinia',
    shortName: 'darwinia2',
    l2: false,
    description: 'Darwinia network chain (RING)',
    rpcUri: { authentication: RPC_AUTHENTICATION.API_KEY_PATH, value: 'https://rpc.darwinia.network' },
    safeAppsRpcUri: { authentication: RPC_AUTHENTICATION.API_KEY_PATH, value: 'https://rpc.darwinia.network' },
    publicRpcUri: { authentication: RPC_AUTHENTICATION.NO_AUTHENTICATION, value: 'https://rpc.darwinia.network' },
    blockExplorerUriTemplate: {
      address: 'https://darwinia.subscan.io/account/{address}}',
      txHash: 'https://darwinia.subscan.io/extrinsic/{{txHash}}',
      api: 'https://darwinia.api.subscan.io/api?module={{module}}&action={{action}}&address={{address}}&apiKey={{apiKey}}',
    },
    nativeCurrency: {
      name: 'RING',
      symbol: 'RING',
...
const networksModified = networks.reduce<Chains>((result, { shortName, chainId }) => {
